...
<main id="booking">
    ...
    <div class="container_booking">
        ...
        <form id="contactform">
            <p><label for="name">ФИО: </label><br><input type="text" name="name" class="form__input" id="name"></p>
            <p><label for="email">Почта: </label><br><input type="email" name="email" class="form__input" id="email"></p>
            <p><label for="time">Время: </label><br><input type="datetime-local" name="time" class="form__input" id="time"></p>
            <p><label for="count">Сколько человек: </label><br><input type="text" name="count" class="form__input" id="count"></p>
            <p><label for="wishes">Пожелания: </label><br><input type="text" name="wishes" class="form__input" id="wishes"></p>

            <div class="header-bth">
                <p><input type="submit" class="header-button" id="sendbtn"></p>
            </div>
        </form>
    </div>
